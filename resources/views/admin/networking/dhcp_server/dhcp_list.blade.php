            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                        <h4 class="mb-sm-0">DHCP Server List</h4>
                        
                        <!-- Button to add DHCP Server -->
                        <a href="{{ route('dhcp_addserver') }}" class="btn btn-primary">
                            </i> Add DHCP Server
                        </a>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">UMClients With DHCP Servers</h4>
                                </div>
                                <div class="card-body">
                                            ...
                                            <tbody>
                                                @foreach($clients as $index => $client)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('dhcp_lease', $client->id) }}" class="btn btn-primary btn-sm">View Leases</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
