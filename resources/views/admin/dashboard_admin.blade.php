...
<head>
    <meta charset="utf-8" />
    <title>Dashboard | ManagerX Ubundi </title>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <!-- start page title -->
                   @include('layouts.page_title_bar')
                    <!-- end page title -->
                            ...
                            <div class="card crm-widget">
                                <div class="card-body p-0">
                                    <div class="row row-cols-xxl-5 row-cols-md-3 row-cols-1 g-0">
                                        <div class="col">
                                            <a href="your-target-url" class="text-decoration-none text-reset">
                                            <div class="py-4 px-3">
                                                <h5 class="text-muted text-uppercase fs-13">Active FTTH USER <i class="ri-arrow-up-circle-line text-success fs-18 float-end align-middle"></i></h5>
                                        ...
                                        <div class="col">
                                            <div class="mt-3 mt-md-0 py-4 px-3">
                                                <h5 class="text-muted text-uppercase fs-13">Active WiFi USERS <i class="ri-arrow-down-circle-line text-danger fs-18 float-end align-middle"></i></h5>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                        ...
                                        <div class="col">
                                            <div class="mt-3 mt-md-0 py-4 px-3">
                                                <h5 class="text-muted text-uppercase fs-13">TOTAL FTTH USERS<i class="ri-arrow-up-circle-line text-success fs-18 float-end align-middle"></i></h5>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <i class="ri-pulse-line display-6 text-muted cfs-22"></i>
                                                    </div>
                                                    <div class="flex-grow-1 ms-3">
                                                        <h2 class="mb-0 cfs-22"><span class="counter-value" data-target="310">0</span></h2>
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- end col -->
                                        <div class="col">
                                            <div class="mt-3 mt-lg-0 py-4 px-3">
                                                <h5 class="text-muted text-uppercase fs-13">TOTAL WiFi USERS<i class="ri-arrow-up-circle-line text-success fs-18 float-end align-middle"></i></h5>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <i class="ri-trophy-line display-6 text-muted cfs-22"></i>
                                                    </div>
                                                    <div class="flex-grow-1 ms-3">
                                                        <h2 class="mb-0 cfs-22"><span class="counter-value" data-target="680">0</span></h2>
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- end col -->
                                        <div class="col">
                                            <div class="mt-3 mt-lg-0 py-4 px-3">
                                                <h5 class="text-muted text-uppercase fs-13">DAILY COLLECTIONS<i class="ri-arrow-up-circle-line text-success fs-18 float-end align-middle"></i></h5>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <i class="ri-exchange-dollar-line display-6 text-muted cfs-22"></i>
                                                    </div>
                                                    <div class="flex-grow-1 ms-3">
                                                        <h2 class="mb-0 cfs-22"><span>&#8373;</span><span class="counter-value" data-target="2659.4"></span></h2>
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- end col -->
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header border-0 align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1" id="live-view-title">Live Overview</h4>
                                    
                                    <!-- Date Range Picker -->
                                    <div class="date-range-selector d-flex me-3">
                                        <label class="me-2">From</label>
                                        <input type="text" id="from-date" class="form-control form-control-sm me-2" placeholder="Select From Date">
                                        <label class="me-2">To</label>
                                        <input type="text" id="to-date" class="form-control form-control-sm me-2" placeholder="Select To Date">
                                        <button class="btn btn-primary btn-sm" onclick="updateDateRange()">Update</button>
                                    </div>
                    
                                    <!-- Service Selector Dropdown -->
                                    <div class="dropdown me-2">
                                        <button class="btn btn-soft-secondary btn-sm material-shadow-none dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                                            <span class="fw-semibold">SERVICE TYPE</span>
                                        </button>
                                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                                            <li><a class="dropdown-item" href="#" onclick="showUtilization('broadband')">Broadband</a></li>
                                            <li><a class="dropdown-item" href="#" onclick="showUtilization('hotspot')">Hotspot</a></li>
                                        </ul>
                                    </div>
                                </div><!-- end card header -->
                    
                                <div class="card-header p-0 border-0 bg-light-subtle">
                                    <div class="row g-0 text-center" id="utilization-data">
                                        <div class="col-6 col-sm-3">
                                            <div class="p-3 border border-dashed border-start-0">
                                                <h5 class="mb-1"><span id="customers-count" class="counter-value" data-target="600">0</span>Mbps</h5>
                                                <p class="text-muted mb-0">Daily Utilization</p>
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-6 col-sm-3">
                                            <div class="p-3 border border-dashed border-start-0">
                                                <h5 class="mb-1"><span id="projects-count" class="counter-value" data-target="4.6">0</span>Gbps</h5>
                                                <p class="text-muted mb-0">Weekly Utilization</p>
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-6 col-sm-3">
                                            <div class="p-3 border border-dashed border-start-0">
                                                <h5 class="mb-1"><span id="revenue-count" class="counter-value" data-target="13.3">0</span>Gbps</h5>
                                                <p class="text-muted mb-0">Monthly Utilization</p>
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-6 col-sm-3">
                                            <div class="p-3 border border-dashed border-start-0 border-end-0">
                                                <h5 class="mb-1 text-success"><span id="hours-count" class="counter-value" data-target="66.57">0</span>Gbps</h5>
                                                <p class="text-muted mb-0">+1 Month</p>
                                            </div>
                                        </div>
                                        <!--end col-->
                                    </div>
                                    ...
                                    <div class="flex-shrink-0">
                                        <div class="dropdown card-header-dropdown">
                                            <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <span class="text-muted">SERVICE TYPE<i class="mdi mdi-chevron-down ms-1"></i></span>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item" href="#">BroadBand</a>
                                        ...
                                        <table class="table table-borderless table-hover table-nowrap align-middle mb-0">
                                            <thead class="table-light">
                                                <tr class="text-muted">
                                                    ...
                                                    <th scope="col" style="width: 20%;">Last Online</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Sep 20, 2021</td>
                                                    <td>
                                                        <span href="#javascript: void(0);" class="text-body fw-medium">iKLICK</span>
                                                    </td>
                                                    <td><span class="badge bg-success-subtle text-success p-2">Online</span></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Sep 23, 2021</td>
                                                    <td>
                                                        <span href="#javascript: void(0);" class="text-body fw-medium">BTS</span>
                                                    </td>
                                                    <td><span class="badge bg-warning-subtle text-warning p-2">Dying</span></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="badge bg-danger-subtle text-danger p-2">Offline</span></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Sep 30, 2021</td>
                                                    <td>
                                                        <span href="#javascript: void(0);" class="text-body fw-medium">PELIRENE</span>
                                                    </td>
                                                    <td><span class="badge bg-success-subtle text-success p-2">Inactive</span></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Sep 30, 2021</td>
                                                    <td>
                                                        <span href="#javascript: void(0);" class="text-body fw-medium">CUBE CONSULT</span>
                                                    </td>
                                                    <td><span class="badge bg-info-subtle text-info p-2">New User</span></td>
                                                    <td>
...
@include('accessories.dash_utilization_graph')
